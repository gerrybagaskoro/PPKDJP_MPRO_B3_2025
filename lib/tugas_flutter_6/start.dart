...
class Tugas6Slicing extends StatefulWidget {
  const Tugas6Slicing({super.key});

  @override
  State<Tugas6Slicing> createState() => _Tugas6SlicingState();
}

class _Tugas6SlicingState extends State<Tugas6Slicing> {
